...
train_df = safe_read_csv("/Users/bindiair/Desktop/machine-state-classification/data_preparation/processed_datasets/training_data_scaled.csv")
...
run_workflow(
    ...
    y=y,
    model=model,
    experiment_name="Stochastic_Gradient_Descent_Imbalanced", 
    val_size=0.2,
    random_state=42,
...
save_results_to_file(filename='stochastic_gradient_descent_imbalanced_results.json') 
